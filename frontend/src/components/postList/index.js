...
export default class PostList extends React.Component {
    ...
    loadPostList = async () => {
        const res = await fetch("http://localhost:8000/v1/questions")
    ...
    render() {
        return (
            <div className='align-items-center'>
                ...
                <h4>Questionslist</h4>
                <br/>
                <ListGroup className='d-flex justify-content-center' as='ul'
                           style={{textDecoration: 'none', width: '60%', marginLeft: '20%'}}>
